        ...
        |context| {
            ...
            assert_contains!(
                ...
                &indoc! {r"
                    ...
                    - SDK installation
                      - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/8.0.101/dotnet-sdk-8.0.101-linux-x64.tar.gz"
                }
            );
            assert_contains!(
                context.pack_stdout,
        ...
        |context| {
            ...
            assert_contains!(
                ...
                &indoc! {r"
                    ...
                    - SDK installation
                      - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/8.0.101/dotnet-sdk-8.0.101-linux-arm64.tar.gz"
                }
            );
            assert_contains!(
                context.pack_stdout,
